    ...
    <aside className="fixed left-0 top-0 h-screen w-64 bg-dark-800 border-r border-dark-600 flex flex-col">
      ...
      <div className="p-6 border-b border-dark-600">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-white">Nirasons</h1>
      ...
      <div className="p-4 border-t border-dark-600">
        ...
        <button
          ...
          className="w-full flex items-center gap-2 px-4 py-2 text-sm text-gray-400 hover:text-white hover:bg-dark-600 rounded-lg transition-colors"
        >
